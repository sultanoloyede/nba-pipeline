...
This phase runs to pre-calculate percentage columns for PR thresholds (5-40)
...
def run_phase_2_5_pr(s3_handler, threshold_start=5, threshold_end=41, force_reprocess=False) -> Tuple[bool, dict]:
    """
