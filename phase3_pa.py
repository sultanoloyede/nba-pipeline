...
def run_phase_3_pa(s3_handler, threshold_start: int = 5, threshold_end: int = 39) -> Tuple[bool, Dict]:
    ...
    try:
        ...
        data_key = f'processed_data_pa/processed_with_pa_pct_{threshold_start}-{threshold_end}.csv'
...
if __name__ == '__main__':
    ...
    success, stats = run_phase_3_pa(s3_handler, threshold_start=5, threshold_end=26)
